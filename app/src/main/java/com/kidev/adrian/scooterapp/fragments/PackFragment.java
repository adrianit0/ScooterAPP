        ...
        ConectorTCP.getInstance().realizarConexion("getBonos", null, new CallbackRespuesta() {
            ...
            public void success(Map<String, String> contenido) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    bono.setNombre(contenido.get("precio["+i+"]"));
                ...
                mAdapter = new BonoAdapter(bonos, R.layout.bono_row, getActivity(), new BonoAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View vista, final Bono bono) {
                        Util.crearAcceptDialog(getActivity(), "Confirmar", "¿Quieres comprar " + bono.getMinutos() + " minutos de bonos por " + bono.getPrecio() + "€?",
            ...
            public void error(Map<String, String> contenido, Util.CODIGO codigoError) {
                Util.crearErrorDialog(getActivity(), "No se ha podido descargar los bonos: " + contenido.get("error"));
            }
        });
    ...
    private void comprarMinutos (final Bono bono) {
        ...
        ConectorTCP.getInstance().realizarConexion("aumentarBonos", parametros, new CallbackRespuesta() {
            ...
            public void success(Map<String, String> contenido) {
                ...
                Util.crearDialog(getActivity(), "Compra correcta", "La compra ha sido realizado satisfactoriamente", null);
            ...
            @Override
            public void error(Map<String, String> contenido, Util.CODIGO codigoError) {
                Util.crearErrorDialog(getActivity(), "No se ha podido comprar el bono: " + contenido.get("error"));
            }
        });
    }
}
